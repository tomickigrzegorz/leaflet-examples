...
const customControl = L.Control.extend({
  ...
  onAdd: function (map) {
    ...
    btn.setAttribute('style', 'background-color: transparent; width: 30px; height: 30px; border: none; display: flex; cursor: pointer; justify-content: center; font-size: 2rem;');
